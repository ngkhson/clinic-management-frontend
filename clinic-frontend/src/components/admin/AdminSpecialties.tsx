        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl w-full max-w-lg shadow-2xl overflow-hidden animate-fade-in">
            ...
            <form onSubmit={handleSaveSpecialty} className="p-6 space-y-5">
              ...
              <div><label className="block text-sm font-medium text-gray-700 mb-1">Đường dẫn hình ảnh (URL)</label><input type="text" value={specForm.imageUrl || ''} onChange={(e) => setSpecForm({ ...specForm, imageUrl: e.target.value })} className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none" placeholder="VD: https://example.com/image.jpg" /></div>
